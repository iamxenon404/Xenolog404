...
export default function Header() {
  ...
  return (
    /* FIXED BAR CONTAINER WITH GLASSMORPHISM AND BOUNDARY STYLING */
    <div className="fixed top-0 left-0 right-0 z-50 bg-[#000000]/70 backdrop-blur-md border-b border-zinc-900/80">
